...
var messages = map[string]entry{
	...
	"game.map.aria":           {ru: "Карта партии: провинции раскрашены по кланам владельцев, по вашим личным спискам, по коалициям, по премиуму или по месту клана в рейтинге", en: "Game map: provinces are coloured by their owners’ clans, by your personal lists, by coalitions, by premium or by the clan’s place in the ranking"},
